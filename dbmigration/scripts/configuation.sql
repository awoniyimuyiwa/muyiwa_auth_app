...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20201004194004_InitialConfigurationMigration')
BEGIN
...
BEGIN
    ...
    VALUES (N'20201004194004_InitialConfigurationMigration', N'5.0.0');
END;
GO
