...
namespace Web.Controllers
{
    ...
    public class DeviceController : Controller
    {
        ...
        private readonly IOptions<IdentityServerOptions> Ioptions;
        ...
        {
            string userCodeParamName = Ioptions.Value.UserInteraction.DeviceVerificationUserCodeParameter;
        ...
        private async Task<ProcessConsentResult> ProcessConsent(DeviceAuthorizationInputModel model)
        {
            ...
            else if (model.Button == "yes")
            {
                ...
                if (model.ScopesConsented != null && model.ScopesConsented.Any())
                {
                    ...
                    if (Constants.ConsentOptions.EnableOfflineAccess == false)
                    {
                ...
                {
                    result.ValidationError = Constants.ConsentOptions.MustChooseOneErrorMessage;
                }
            }
            else
            {
                result.ValidationError = Constants.ConsentOptions.InvalidSelectionErrorMessage;
            }
        ...
        private DeviceAuthorizationViewModel CreateConsentViewModel(string userCode, DeviceAuthorizationInputModel model, DeviceFlowAuthorizationRequest request)
        {
            ...
            if (Constants.ConsentOptions.EnableOfflineAccess && request.ValidatedResources.Resources.OfflineAccess)
            {
        ...
        private ScopeViewModel GetOfflineAccessScope(bool check)
        {
            return new ScopeViewModel
            {
                ...
                DisplayName = Constants.ConsentOptions.OfflineAccessDisplayName,
                Description = Constants.ConsentOptions.OfflineAccessDescription,
                Emphasize = true,
                Checked = check
            };
        }
